...
public class DRPLibrary {
	...
	public DRPLibrary() {
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, DebugConfig.CONFIG_SPEC);
...
//        });
	...
	public static class DebugConfig{
		...
		public DebugConfig(ForgeConfigSpec.Builder builder) {
			...
			rgba = builder
					.comment("Test 2")
					.translation("drplibrary.config.test2")
					.defineInRange("rgba", 0xFFFF0000, 0, 0xFFFFFFFF);
			builder.pop();
		}
	}
}

...
public class ModularGui_Drawer {
	...
	public static void drawBackground(int posX, int posY, int width, int height, boolean drawCenter, boolean isHollow) {
		if(!isHollow)
			Minecraft.getInstance().textureManager.bindTexture(ModularGuiHandler.currentGui.getModularBG().getPath());
		else
			Minecraft.getInstance().textureManager.bindTexture(ModularGuiHandler.currentGui.getModularBG().getPathHollow());
	...
	public static void drawButtons(int posX, int posY, int width, int height, State state) {
		switch(state){
			case DISABLED:		
				Minecraft.getInstance().textureManager.bindTexture(ModularGuiHandler.currentGui.getModularButtons().getPathDisabled());
				break;
			case ENABLED:
				Minecraft.getInstance().textureManager.bindTexture(ModularGuiHandler.currentGui.getModularButtons().getPathEnabled());
				break;
			case HOVERED:
				Minecraft.getInstance().textureManager.bindTexture(ModularGuiHandler.currentGui.getModularButtons().getPathHovered());
				break;
		}

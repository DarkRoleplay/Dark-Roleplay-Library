...
import net.dark_roleplay.library.unstable.experimental.blueprints.v2.Constants.CompressionType;
...
public class LayerLoader {
	...
	public static Layer loadLayer(NBTTagCompound compound, IPallete globalPallete) {
		...
		NBTTagList entities = compound.getList("Entities", NBT.TAG_COMPOUND);
		NBTTagList tileEntities = compound.getList("Entities", NBT.TAG_COMPOUND);
		NBTTagCompound custom = compound.getCompound("Custom");

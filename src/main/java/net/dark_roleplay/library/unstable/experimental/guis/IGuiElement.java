...
public interface IGuiElement {
	...
	public abstract class IMPL extends Gui implements IGuiElement{
		...
		protected static void drawLine(int x1, int y1, int x2, int y2, int color) {
			...
			float angle = getAngleRad(new Point2d(x1,y1), new Point2d(x2,y2));
		...
		private static float getAngleRad(Point2d a, Point2d b){
			Point2d vec = new Point2d(b.getX() - a.getX(), b.getY() - a.getY());
